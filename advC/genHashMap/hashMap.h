...
typedef struct Map_Stats {
	...
	double averageChainLength;  /* average length of none empty chains */
} Map_Stats;
 ...
 * @return MAP_SUCCESS or MAP_ALLOCATION_ERROR or MAP_UNINITIALIZED_ERROR if null pointer or smaller capacity is given
 */
 ...
 * @retval  MAP_KEY_NOT_FOUND_ERROR if key not found
 * @retval  MAP_UNINITIALIZED_ERROR
 * @retval  MAP_PVALUE_NULL_ERROR if pvalue is null
 * @warning key must be unique and destinct
 */
