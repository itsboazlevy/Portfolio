 ...
 * @params _list : list to return begin iterator, pointing at first element or at the end if list is empty which is the tail
 * @return iterator pointing at the list's beginning which is the first element
 */
 ...
 * @return an iterator pointing at the list's end which is the tail
 */
 ...
 * @return an iterator pointing at the element inserted or NULL on allocation error
 */
