 ...
 * @details find the element for which the predicate reuturns a non zero value in the half open range [begin..end)
 ...
 * @details remove all elements from the half open range [_begin.._end) and insert them before _dest
 * O(?)
